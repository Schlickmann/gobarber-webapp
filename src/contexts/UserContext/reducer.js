...
const Types = {
  ...
  HANDLE_AVATAR_UPDATE_REQUEST: '@userContext/HANDLE_AVATAR_UPDATE_REQUEST',
  HANDLE_AVATAR_UPDATE_SUCCESS: '@userContext/HANDLE_AVATAR_UPDATE_SUCCESS',
  HANDLE_AVATAR_UPDATE_FAILURE: '@userContext/HANDLE_AVATAR_UPDATE_FAILURE',
};
